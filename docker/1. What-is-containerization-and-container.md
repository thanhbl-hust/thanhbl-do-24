...
<div style="text-align: center;">
  <img src="pic/docker-architecture.png" alt="Description of image" style="max-width: 650px; width: 100%; height: auto;">
...
- `Docker Registry`: a places to store Docker images. Dockerhub is a public registry that anyone can use, and Docker looks for images on Dockerhub by default when you use command `docker pull`.
...
- [Amazon Web Services](https://aws.amazon.com/what-is/containerization/)

- [Kodekloud](https://kodekloud.com/blog/docker-containerization/)

- [IBM](https://www.ibm.com/topics/containerization)

- [GeeksforGeeks](https://www.geeksforgeeks.org/containerization-architecture-in-system-design/)

- [DCLessions](https://www.dclessons.com/how-docker-engine-works)
